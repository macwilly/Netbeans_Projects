...
--
-- Host: localhost:3306
-- Generation Time: Sep 19, 2017 at 01:46 AM
...
(3, 'test', 0x8ff532d3b3a8fbe0bef61eac4078a86e, 1, 'John', 'Testington', 1, 'jtestington@rit.edu');
...
--
ALTER TABLE `users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for all users', AUTO_INCREMENT=4;